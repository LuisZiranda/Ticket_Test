...
class Archived_Ticket : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_archived__ticket, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        coleccion.get().addOnSuccessListener { querySnapshot ->
            ...
            val recyclerView: RecyclerView =view.findViewById(R.id.recyclerViewArchived)
